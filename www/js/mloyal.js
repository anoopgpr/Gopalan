...
var json_fb='https://taghash.co/mloyalApps/facebookgopalan.php';
var RSS_twitter='https://taghash.co/mloyalApps/twitter.php?uname=gopalangroup';
var RSS_pinterest='http://103.25.128.61/projects/taghash/mloyalApps/pinteresttantra.php?brand=gopalan';
var RSS_instagram='https://www.instagram.com/gopalan/?__a=1';
var RSS_youtube='http://xceedfbapps.com/mloyalfeeds/youtube.php?brandname=gopalan';
var RSS_tumblr='http://xceedfbapps.com/mloyalfeeds/tumblr.php?brandurl=http://gopalan.tumblr.com';

var brandname='gopalan';
var aboutus_det='gopalan';
var brand_url='https://www.gopalanenterprises.com/';
var cart = { cartdata: []};
...
var SERVER = "https://gopalan.mloyalretail.com/m/";
var SERVER1 = "https://gopalan.mloyalretail.com/";
var SERVER2 = "https://gopalan.mloyalretail.com/APIs/";


var app_versionCode = '25';
...
$(document).ready(function(event){
			   ...
			   if($.mobile.activePage.is('#homepage')){
                 ...
                 //getContacts();
                  if(localStorage.getItem("usernamegopalan")!=null && localStorage.getItem("usernamegopalan")!='' && localStorage.getItem("passwordgopalan")!=null && localStorage.getItem("passwordgopalan")!='')
                    {
                            $('#username').val(localStorage.getItem("usernamegopalan"));
                            $('#password_myacc').val(localStorage.getItem("passwordgopalan"));
							user.mobile = localStorage.getItem('usernamegopalan');
							var pwd = localStorage.getItem('passwordgopalan');
                        ...
                        if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
                           ...
                           // alert(user.firstname);
                            ...
                            document.getElementById("profilepts1").innerHTML=user.total+' points';
                             ...
                             $("#wait").css("display","none");
                             authenticate();
                          if(imageExists('https://taghash.co/mloyalfileupload/uploads/gopalan_'+localStorage.getItem("usernamegopalan")+'.jpg'))
                          {
                              document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/gopalan_'+localStorage.getItem("usernamegopalan")+'.jpg';
                          }                     
                     }
				   else if(localStorage.getItem("usernamegopalan")!=null && localStorage.getItem("usernamegopalan")!='' && (localStorage.getItem("passwordgopalan")==null || localStorage.getItem("passwordgopalan")=='')) 
	                 {
				   ...
				   else
					  {
						    ...
						    $.mobile.changePage( "#page-confirm-login", { transition: "none"} );
			...
			success: function(data, textStatus, xhr) {
			 ...
			 if(data.toLowerCase()=='success'){
				 ...
				 $('#login-msg').html('The  passcode has been sent to your mobile.Please check your SMS.');
			      ...
			      $('#username').val(mob);
				  localStorage.setItem('usernamegopalan',mob);
...
function authenticate()
{
 ...
 if(uname=='' || pwd==''){
  ...
  $.ajax({
   ...
   localStorage.setItem('usernamegopalan',uname);
   localStorage.setItem('passwordgopalan',pwd);
 ...
 if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
    ...
    {
	    if(localStorage.getItem("profiledone_gopalan")){
    ...
    error: function(xhr, textStatus, errorThrown) {
	user.mobile = localStorage.getItem('usernamegopalan');
	pwd = localStorage.getItem('passwordgopalan');
	uname = user.mobile;
    user.balance = localStorage.getItem('balance');
    user.firstname = localStorage.getItem('firstname');
    user.lastname = localStorage.getItem('lastname');
...
$(document).on('pageinit', '#profilepage', function (event, ui) {
	...
	$.ajax({
			...
			success: function(data, textStatus, xhr) {
				...
				localStorage.setItem("profiledone_gopalan","Yes");
...
function showRewards(){
	...
	openInWebView('https://gopalan.mloyalretail.com/microsite/');
	//RewardsNA();
	/*
	if(user.mobile==null || user.mobile=='')
	{
...
if(id=='rewardstore' || id=='reward-cat' || id=='reward-brand')
	{
	tabserver = "https://gopalan.mloyalretail.com/Rewards/";
	}
else
	{
	
	tabserver = "https://gopalan.mloyalretail.com/m/";
	}
	$.getJSON(
		tabserver+url, {
		//page: url,
...
function renderTemplate(pageID, json) {
	...
	case 'specials':
		...
		if(json.length == 0)
		{
			str = '<span style="text-align:center;display:block;margin:20px auto;">No Offer found</span>';
		}
		else
		{
	...
	case 'inbox':
        ...
        str += '<span class="msghdr">DM-Gopala</span><span class="msgTime">'+json[i].msgtime+'</span>';
...
var str = '';
	...
	switch (pageID) {
		...
		case 'aboutus':
			...
			/*else if(parseInt(user.balance)>=10001 && parseInt(user.balance)<=15000)
            {
               document.getElementById('silverslab').className = '';
               document.getElementById('goldslab').className = '';
		       document.getElementById('platinumslab').className = '';
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json);
          ...
          localStorage.setItem('facebook_gopalan',JSON.stringify(json.item));
		 ...
		 try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('facebook_gopalan')));
		 }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.feed.entry);
          ...
          localStorage.setItem('youtube_gopalan',JSON.stringify(json.feed.entry));
		   ...
		   try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('youtube_gopalan')));
		   }
		   catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
...
else if(url==RSS_twitter)
{
  ...
  $.ajax({
            ...
            localStorage.setItem('twitter_gopalan', JSON.stringify(data));
                },
                error: function (xhr, textStatus, errorThrown) {
				...
				{
					renderTemplate(id, JSON.parse(localStorage.getItem('twitter_gopalan')));
					//alert('here in catch');
				}
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.body);
          ...
          localStorage.setItem('pinterest_gopalan',JSON.stringify(json.body));
		   ...
		   try{
			    renderTemplate(id,JSON.parse(localStorage.getItem('pinterest_gopalan')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_tumblr)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('tumblr_gopalan',JSON.stringify(json.channel.item));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('tumblr_gopalan')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_instagram)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('instagram_gopalan',JSON.stringify(json.user));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('instagram_gopalan')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
function receivedEvent(id) {
 ...
 var push = PushNotification.init({ "android": {"senderID": "436150347639"}});
...
function addincart(i)
{
	...
	cart.cartdata.push({ 
   "index":i,
   "url" : "https://gopalan.mloyalretail.com/"+jsonary[i].brand_logo,
...
function checkout(){
  ...
  $.ajax({
    url: 'https://gopalan.mloyalretail.com/Rewards/complete.asp',
    type: 'GET',
    timeout: 50000,
...
function giftfriend(){
  ...
  var val=$('#giftpt').val();
  $.ajax({
    url: 'https://gopalan.mloyalretail.com/m/gift_points_api.asp',
    type: 'GET',
    timeout: 50000,
    dataType: 'text', //xml/html/script/json/jsonp
...
function shareApp()
{
	window.plugins.socialsharing.share('Hi, Join Gopalan Privilege.', null, 'https://taghash.co/shareimg/gopalan.jpg', 'https://gopalan.mloyalretail.com/mapp');
}
...
function rateApp()
{
	var deviceType = (navigator.userAgent.match(/iPad/i))  == "iPad" ? "iPad" : (navigator.userAgent.match(/iPhone/i))  == "iPhone" ? "iPhone" : (navigator.userAgent.match(/Android/i)) == "Android" ? "Android" : (navigator.userAgent.match(/BlackBerry/i)) == "BlackBerry" ? "BlackBerry" : "null";
		 if (deviceType=='iPad' || deviceType=='iPhone') 
			 ...
			 {
               window.open("market://details?id=com.mobiquest.gopalan","_system");
...
function showShop(){
    ...
    //openInWebView('https://www.gopalanenterprises.com/');
	var ref = window.open('https://www.gopalanenterprises.com/', '_blank');
   
}
function showShop11(){

  //openInWebView('http://www.gopalanenterprises.com');
...
var toast_p = function (msg) {
    $("<div class='ui-loader ui-overlay-shadow ui-body-e ui-corner-all'><h5>" + msg + "</h5></div>")
            .css({display: "block",
                ...
                left: ($(window).width() - 284) / 2,
                top: $(window).height() / 2})
            .appendTo($.mobile.pageContainer).delay(8500)
            .fadeOut(400, function () {
                $(this).remove();
            });
}
...
$("input[type=file]").change(function(){
  ...
  // alert($("input[type=file]")[0].files[0]);
	...
	aFormData.append("mobile", localStorage.getItem("usernamegopalan"));
    aFormData.append("brand", "gopalan");
	...
	$.ajax(
    {
      ...
      success     : 
        function(data)
        {
         ...
         document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/gopalan_'+localStorage.getItem("username")+'.jpg';
      //   document.getElementById("cardImage").src='https://taghash.co/mloyalfileupload/uploads/gopalan_'+localStorage.getItem("username")+'.jpg';
        }
    });
...
function logoutApp()
{
	localStorage.setItem("usernamegopalan",'');
	localStorage.setItem("passwordgopalan",'');
	localStorage.setItem("profiledone_gopalan",'');
...
function uploadPhoto(imageURI) {
				...
				var fName='gopalan_'+user.mobile;
...
$(document).on('pageshow', '#gobowl', function (event, ui) {

    loadGobowl();
    
});

$(document).on('pageshow', '#organics', function (event, ui) {

    loadOrganics();
    
});

$(document).on('pageshow', '#organics1', function (event, ui) {

    loadOrganics1();
    
});

$(document).on('pageshow', '#organics2', function (event, ui) {

    loadOrganics2();
    
});

$(document).on('pageshow', '#interiors', function (event, ui) {

    loadInteriors();
    
});

$(document).on('pageshow', '#cinemas', function (event, ui) {

    loadCinemas();
    
});

$(document).on('pageshow', '#cinemas1', function (event, ui) {

    loadCinemas1();
    
});

$(document).on('pageshow', '#cinemas2', function (event, ui) {

    loadCinemas2();
    
});

$(document).on('pageshow', '#cinemas3', function (event, ui) {

    loadCinemas3();
    
});

$(document).on('pageshow', '#cinemas11', function (event, ui) {
...
function loadGobowl()
{
	 ...
	 var tabserver='https://taghash.co/gopalan/getgobowlmenu.php';
	 ...
	 $.getJSON(
            tabserver , {  }, 
			 ...
			 //$.mobile.changePage("#rewardsmain", {transition: "none"});
				...
				str+='<table class="gobowl_tbl">';
				str+='<tr style="background: #ccab55;">';
				str+='<td>Menu</td>';
				str+='<td>Price</td>';
				str+='</tr>';
				...
				{
					str+='<tr>';
					str+='<td>'+json[i].item+'</td>';
					str+='<td>Rs. '+json[i].price+'</td>';
					str+='</tr>';
		        }

				str+='</table>';

				document.getElementById("gobowl_div").innerHTML= str;
...
function loadOrganics()
{
	 
	 var tabserver='https://taghash.co/gopalan/getorganics.php';
	 ...
	 $.getJSON(
            tabserver , {  }, 
			 ...
			 //$.mobile.changePage("#rewardsmain", {transition: "none"});
				...
				for(var i=0;i<json.length;i++)
				{
					str+='<div class="ui-grid-solo" style="padding:10px;margin:10px;border:1px solid #aeaeae">';
				...
				document.getElementById("organics_div").innerHTML= str;
	 ...
	 $.getJSON(
            tabserver , {  }, 
			 ...
			 //$.mobile.changePage("#rewardsmain", {transition: "none"});
				...
				document.getElementById("organics_div1").innerHTML= str;
...
function loadOrganics2()
{
	 
	 var tabserver='https://taghash.co/gopalan/getorganics_fresh.php';
	 ...
	 $.getJSON(
            tabserver , {  }, 
			 ...
			 //$.mobile.changePage("#rewardsmain", {transition: "none"});
				...
				document.getElementById("organics_div2").innerHTML= str;
...
function loadAds()
{
	 $.mobile.changePage( "#ads", { transition: "none"} );

	 var tabserver='https://taghash.co/gopalan/getads.php';
...
function loadCinemas()
{
	 ...
	 var tabserver='https://taghash.co/gopalan/getcinemas.php';
	 ...
	 $.getJSON(
            tabserver , {  }, 
			 ...
			 console.log("SSSS" + JSON.stringify(json));
				...
				document.getElementById("cinemas_div").innerHTML= str;

				//$.mobile.changePage( "#cinemas", { transition: "none"} );
...
function loadCinemas1()
{
	 ...
	 var tabserver='https://taghash.co/gopalan/getcinemas_signaturemall.php';
	 ...
	 $.getJSON(
            tabserver , {  }, 
			 ...
			 console.log("SSSS" + JSON.stringify(json));
				...
				document.getElementById("cinemas_div1").innerHTML= str;
...
function loadCinemas2()
{
	 
	 var tabserver='https://taghash.co/gopalan/getcinemas_arcademall.php';
	 ...
	 $.getJSON(
            tabserver , {  }, 
			 ...
			 console.log("SSSS" + JSON.stringify(json));
				...
				document.getElementById("cinemas_div2").innerHTML= str;
...
function loadCinemas3()
{
	 
	 var tabserver='https://taghash.co/gopalan/getcinemas_innovationmall.php';
	 ...
	 $.getJSON(
            tabserver , {  }, 
			 ...
			 console.log("SSSS" + JSON.stringify(json));
				...
				document.getElementById("cinemas_div3").innerHTML= str;
...
function loadCinemas11()
{
	 
	 var tabserver='https://taghash.co/gopalan/getcinemas_grandmall.php';
	 ...
	 $.getJSON(
            tabserver , {  }, 
			 ...
			 console.log("SSSS" + JSON.stringify(json));
				...
				document.getElementById("cinemas_div11").innerHTML= str;
...
{
	$.mobile.changePage( "#specials1", { transition: "none"} );
}

function showSpecial_others()
{
	 document.getElementById("spec2").innerHTML= '';

	 $.mobile.changePage( "#specials2", { transition: "none"} );

	 var tabserver='https://taghash.co/gopalan/getspecials.php';
	 ...
	 $.getJSON(
            tabserver , {  }, 
			 ...
			 //console.log("SSSS" + JSON.stringify(json));
				...
				document.getElementById("spec2").innerHTML= str;
...
function showSpecial_grandm()
{
	 document.getElementById("spec2").innerHTML= '';

	 $.mobile.changePage( "#specials2", { transition: "none"} );

	 var tabserver='https://taghash.co/gopalan/getspecials_grandm.php';
...
function showSpecial_gsignaturemall()
{
	 document.getElementById("spec2").innerHTML= '';

	 $.mobile.changePage( "#specials2", { transition: "none"} );

	 var tabserver='https://taghash.co/gopalan/getspecials_gsignaturemall.php';
...
function loadInteriors()
{
	 ...
	 var tabserver='https://taghash.co/gopalan/getinteriors.php';
	 ...
	 $.getJSON(
            tabserver , {  }, 
			 ...
			 //console.log("SSSS" + JSON.stringify(json));
				...
				document.getElementById("interiors_div").innerHTML= str;
...
function checkapp_Version()
{
     ...
     $.getJSON(
      'https://taghash.co/gopalan/getapp_version.php', 
			{

			},
		    function (json) {

				 localStorage.setItem("gopalan_vcode", JSON.stringify(json));
...
function checkapp_Version_popup()
{
	...
	str +='<p class="notification_msg">New version of your application available. Do you want to update it? </p>';
	...
	str +='</div>';
	str +='</div>';	
	$("#page-confirm-login").prepend(str);
